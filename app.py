...
# É usado para o machine learning, mas a técnica é famosa no meio acadêmico da estatística. Seu racional é baseado nos estudos de
# Thomas Bayes e “naive” significa ingênuo, uma referência a linha de análise do algoritmo paa as características da base de dados 
# em questão.
